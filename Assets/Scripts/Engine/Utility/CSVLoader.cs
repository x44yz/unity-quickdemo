...
public class CSVLoader
{
    ...
    {
        return GetFieldValue(fieldName, defaultValue == null);
    }
    ...
    public Color ReadHexColor(string fieldName, Color defaultColor = new Color())
    {
        Color c = defaultColor;
        if (ColorUtility.TryParseHtmlString(ReadString(fieldName), out c))
            return c;
        return defaultColor;
    }
