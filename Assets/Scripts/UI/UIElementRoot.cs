...
public class UIElementRoot : MonoBehaviour
{
    ...
    public string CacheUIElements(Dictionary<string, UIElement> cache, bool isErrLog = false)
    {
        ...
        foreach(var t in ts)
        {
            ...
            // NOTE:
            // if contain other UIElementRoot, dont cache its UIElements
            // TODO: performance optimize
            var tw = Utils.GetComponentOnlyInParent<UIElementRoot>(t);
...
#if UNITY_EDITOR
[CustomEditor(typeof(UIElementRoot))]
public class UIElementRootEditor : UnityEditor.Editor
{
    ...
    public override void OnInspectorGUI() 
    {
        ...
        UIElementRoot widget = target as UIElementRoot;
